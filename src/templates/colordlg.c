...
** $Id$
** 
** colordlg.c: Color Select Dialog.
** 
...
static void InitColorPanels(HWND hDlg)
{
    ...
    static RGB rgbBasics[] = {
        { 0xC0,0xC0, 0xFF, 0xFF },/* Light Red */ { 0x00, 0x00, 0xFF, 0xFF }, /* Red */
        { 0x00, 0x00, 0xC0, 0xFF},/* Dark Red */ { 0x00, 0x00, 0x80,0xFF }, /* Very Drak Red */
        { 0xC0, 0xFF, 0xC0, 0xFF},/* Light Green */ { 0x00,0xFF,0x00, 0xFF}, /* Green */
        { 0x00, 0xC0, 0x00, 0xFF},/* Dark Green */ { 0x00, 0x80, 0x00, 0xFF}, /* Very Dark Green */
        { 0xFF, 0xC0, 0xC0, 0xFF}, /* Light Blue */ { 0xFF, 0x00, 0x00, 0xFF}, /* Blue */
        { 0xC0, 0x00, 0x00, 0xFF}, /* Dark Blue */ { 0x80, 0x00, 0x00, 0xFF}, /* Very Dark Blue */
        { 0xC0, 0xFF, 0xFF, 0xFF}, /* Light Yellow */ { 0x00, 0xFF, 0xFF, 0xFF}, /* Yellow */
        { 0x00, 0xC0, 0xC0, 0xFF}, /* Drak Yellow */ { 0x00, 0x80, 0x80, 0xFF}, /* Very Dark Yellow */
        { 0xFF, 0xFF, 0xC0, 0xFF}, /* Light Cyan */ { 0xFF, 0xFF, 0x00, 0xFF}, /* Cyan */
        { 0xC0, 0xC0, 0x00, 0xFF}, /* Dark Cyan */ 
        { 0xFF, 0xC0, 0xFF, 0xFF}, /* Light Magenta */
        { 0xFF, 0x00, 0xFF, 0xFF}, /* Magenta */
        { 0xC0, 0x00, 0xC0, 0xFF}, /* Dark Magenta */ { 0xA8, 0xDC, 0xFF, 0xFF}, /* Light Orange */
        { 0x58, 0xA8, 0xFF, 0xFF}, /* Orange */ { 0x00, 0x80, 0xFF, 0xFF }, /* Dark Orange */
        { 0xF0, 0xF0, 0xF0, 0xFF}, /* White */  { 0xC0, 0xC0, 0xC0, 0xFF },/* Lieght Gray */
        { 0x80, 0x80, 0x80, 0xFF}, /* Gray */ { 0x40, 0x40, 0x40, 0xFF}, /* Dark Gray */
